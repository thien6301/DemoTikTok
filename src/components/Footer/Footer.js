    ...
    return ( 
        <div className={cx('wrapper')}>
            <div className= {cx('title')} >
                <a style={{color: "rgba(22, 24, 35, .5)" }}href= "https://www.tiktok.com/about?lang=en">About</a>
                ...
                <a style={{color: "rgba(22, 24, 35, .5)"}}href= "https://www.tiktok.com/about?lang=en">Careers</a>
            </div>
            <div className= {cx('title')}>
                <a style={{color: "rgba(22, 24, 35, .5) "}}href= "https://www.tiktok.com/about?lang=en"> TikTok for Good</a>
                <a style={{color: "rgba(22, 24, 35, .5) "}}href= "https://www.tiktok.com/about?lang=en"> Advertis</a>
                <a style={{color: "rgba(22, 24, 35, .5) "}}href= "https://www.tiktok.com/about?lang=en"> Deverlopers</a>
                <a style={{color: "rgba(22, 24, 35, .5) "}}href= "https://www.tiktok.com/about?lang=en"> Transparency</a>
